...
const miningAddress = "consensusdev:qrcqat6l9zcjsu7swnaztqzrv0s7hu04skpaezxk43y4etj8ncwfk89tjwc8f"
...
func runDAATest(t *testing.T, testName string, runDuration time.Duration,
	...
	tearDownConsensusd := common.RunConsensusdForTesting(t, "consensusd-daa-test", rpcAddress)
	defer tearDownConsensusd()

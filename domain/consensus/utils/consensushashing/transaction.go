...
import (
	...
	"github.com/consensus-network/consensusd/domain/consensus/utils/serialization"

	"github.com/consensus-network/consensusd/domain/consensus/model/externalapi"
	"github.com/consensus-network/consensusd/domain/consensus/utils/hashes"
	"github.com/consensus-network/consensusd/domain/consensus/utils/transactionhelper"
	"github.com/consensus-network/consensusd/util/binaryserializer"
...
// writeTransactionInput encodes ti to the consensus protocol encoding for a transaction
// input to w.

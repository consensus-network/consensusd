...
// This example demonstrates creating a script which pays to a consensus address.
...
func ExamplePayToAddrScript() {
	...
	// PayToAddrScript.
	addressStr := "consensus:qqj9fg59mptxkr9j0y53j5mwurcmda5mtza9n6v9pm9uj8h0wgk6u32akz3mg"
	address, err := util.DecodeAddress(addressStr, util.Bech32PrefixConsensus)
	if err != nil {
		fmt.Println(err)
		return
	}
...
func ExampleExtractScriptPubKeyAddress() {
	...
	// Output:
	// Script Class: pubkey
	// Address: consensus:qzy6cf82zzah2xh5jwtz8nx9u4gdj6zzke8gljs0v055ksmnl424us79fnlrm
}

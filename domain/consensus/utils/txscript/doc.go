...
consensus transaction scripts.

# Script Overview

Consensus transaction scripts are written in a stack-base, FORTH-like language.

The consensus script language consists of a number of opcodes which fall into
...
Typical consensus scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend consensus.

...
// SignatureScript creates an input signature script for tx to spend CSS sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend CSS sent

...
import (
	...
	"github.com/consensus-network/consensusd/domain/consensus/utils/merkle"
	"github.com/consensus-network/consensusd/domain/consensus/utils/mining"
	"github.com/consensus-network/consensusd/domain/consensus/utils/pow"
...
func TestPOW(t *testing.T) {
	...
	testutils.ForAllNets(t, false, func(t *testing.T, consensusConfig *consensus.Config) {
		...
		if consensusConfig.Name != "consensus-mainnet" {

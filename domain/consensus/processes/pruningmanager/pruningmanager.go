...
import (
	...
	"github.com/consensus-network/consensusd/domain/consensus/utils/virtual"
...
// This is a sanity test, to make sure that consensusd doesn't store, and subsequently sends syncing peers the wrong UTXOSet.

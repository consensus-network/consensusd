...
func (v *transactionValidator) checkTransactionAmountRanges(tx *externalapi.DomainTransaction) error {
	...
	// as a sompi. One consensus is a quantity of sompi as defined by the
	// sompiPerConsensus constant.
	...
	for _, txOut := range tx.Outputs {
		...
		// This is impossible for Consensus, but perhaps possible if an alt increases

...
const (
	...
	defaultSubsidyGenesisReward                    = 1 * constants.SompiPerConsensus
	defaultPreDeflationaryPhaseBaseSubsidy         = 880 * constants.SompiPerConsensus
	defaultDeflationaryPhaseBaseSubsidy            = 440 * constants.SompiPerConsensus
	...
	// We define a month as 30.4375 days
	// One Month in seconds = 30.4375 * 24 * 60 * 60 = 2629800
	defaultDeflationaryPhaseDaaScore = 2629800

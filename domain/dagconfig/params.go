...
import (
	...
	"github.com/consensus-network/consensusd/util/network"
...
// Params defines a Consensus network by its parameters. These parameters may be
// used by Consensus applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// PruningProofM is the 'm' constant in the pruning proof. For more details see: https://github.com/consensus-network/research/issues/3
...
// MainnetParams defines the network parameters for the main Consensus network.
var MainnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "consensus-mainnet",
	Net:         appmessage.Mainnet,
	RPCPort:     "10105",
	DefaultPort: "10106",
	DNSSeeds: []string{
		// Team DNS seed
		"seeder-1.consensus-network.com",
		"seeder-2.consensus-network.com",
		"seeder-3.consensus-network.com",
	},
	...
	Prefix: util.Bech32PrefixConsensus,
...
// TestnetParams defines the network parameters for the test Consensus network.
var TestnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "consensus-testnet-1",
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixConsensusTest,
...
// SimnetParams defines the network parameters for the simulation test Consensus
...
var SimnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixConsensusSim,
...
// DevnetParams defines the network parameters for the development Consensus network.
var DevnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "consensus-devnet",
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixConsensusDev,
...
// ErrDuplicateNet describes an error where the parameters for a Consensus
// network could not be set due to the network already being a standard
// network or previously-registered into this package.
var ErrDuplicateNet = errors.New("duplicate Consensus network")

var registeredNets = make(map[appmessage.ConsensusNet]struct{})

// Register registers the network parameters for a Consensus network. This may

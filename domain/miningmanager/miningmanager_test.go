...
import (
	...
	"github.com/consensus-network/consensusd/domain/consensusreference"
	"github.com/consensus-network/consensusd/domain/miningmanager/model"
	...
	"github.com/consensus-network/consensusd/domain/miningmanager"
...
func generateNewCoinbase(addressPrefix util.Bech32Prefix, op opType) (*externalapi.DomainCoinbaseData, error) {
	...
	_, publicKey, err := libconsensuswallet.CreateKeyPair(op == opECDSA)
	if err != nil {
		return nil, err
	}
	var address string

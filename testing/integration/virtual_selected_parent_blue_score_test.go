...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := consensusd.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = consensusd.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = consensusd.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(

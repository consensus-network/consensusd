...
func parseCommand(args []string, commandDescs []*commandDescription) (*protowire.ConsensusdMessage, error) {
	...
	return generateConsensusdMessage(commandValue, commandDesc)
}

...
var keyChains = []uint8{libconsensuswallet.ExternalKeychain, libconsensuswallet.InternalKeychain}
...
func (s *server) updateAddressesAndLastUsedIndexes(requestedAddressSet walletAddressSet,
	...
	for _, entry := range getBalancesByAddressesResponse.Entries {
		...
		if walletAddress.keyChain == libconsensuswallet.ExternalKeychain {

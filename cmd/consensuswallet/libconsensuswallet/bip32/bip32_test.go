...
func TestBIP32SpecVectors(t *testing.T) {
	...
	testVectors := []testVector{
		...
		{
			seed:    "000102030405060708090a0b0c0d0e0f",
			version: ConsensusMainnetPrivate,
			paths: []testPath{
				{
					path:               "m",
		...
		{
			seed:    "4b381541583be4423346c643850da4b320e46a87ae3d2a4e6da11eba819cd4acba45d239319ac14f863b8d5ab5a0d0c64d2e8a1e7d1457df2e5a3c51c73235be",
			version: ConsensusTestnetPrivate,
			paths: []testPath{
				{
					path:               "m",
		...
		{
			seed:    "4b381541583be4423346c643850da4b320e46a87ae3d2a4e6da11eba819cd4acba45d239319ac14f863b8d5ab5a0d0c64d2e8a1e7d1457df2e5a3c51c73235be",
			version: ConsensusDevnetPrivate,
			paths: []testPath{
				{
					path:               "m",
		...
		{
			seed:    "4b381541583be4423346c643850da4b320e46a87ae3d2a4e6da11eba819cd4acba45d239319ac14f863b8d5ab5a0d0c64d2e8a1e7d1457df2e5a3c51c73235be",
			version: ConsensusSimnetPrivate,
			paths: []testPath{
				{
					path:               "m",
...
func TestExtendedKey_DeriveFromPath(t *testing.T) {
	...
	master, err := NewMaster(seed, ConsensusMainnetPrivate)
	if err != nil {
		t.Fatalf("GenerateSeed: %+v", err)
	}

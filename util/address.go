...
import (
	...
	"github.com/consensus-network/consensusd/util/bech32"
)
...
const (
	...
	Bech32PrefixConsensusDev

	// Prefix for the test network.
	Bech32PrefixConsensusTest

	// Prefix for the simulation network.
	Bech32PrefixConsensusSim
)
...
var stringsToBech32Prefixes = map[string]Bech32Prefix{
	"consensus":     Bech32PrefixConsensus,
	"consensusdev":  Bech32PrefixConsensusDev,
	"consensustest": Bech32PrefixConsensusTest,
	"consensussim":  Bech32PrefixConsensusSim,
}
...
// and a payload which encodes the consensus network and address type. It is used
...
// with the passed consensus network.

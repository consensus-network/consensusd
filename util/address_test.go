...
func TestAddresses(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "mainnet p2pk",
			addr:    "consensus:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35c8mx62u3l",
			encoded: "consensus:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35c8mx62u3l",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixConsensus,
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c}
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixConsensus)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixConsensus,
		},
		{
			name:    "mainnet p2pk 2",
			addr:    "consensus:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cx7flvuzv",
			encoded: "consensus:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cx7flvuzv",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixConsensus,
				[util.PublicKeySize]byte{
			...
			passedPrefix:   util.Bech32PrefixConsensus,
			expectedPrefix: util.Bech32PrefixConsensus,
		},
		{
			name:    "testnet p2pk",
			addr:    "consensustest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35cwtnp95ze",
			encoded: "consensustest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35cwtnp95ze",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixConsensusTest,
				[util.PublicKeySize]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixConsensusTest)
			},
			passedPrefix:   util.Bech32PrefixConsensusTest,
			expectedPrefix: util.Bech32PrefixConsensusTest,
		},

		// ECDSA P2PK tests.
		{
			name:    "mainnet ecdsa p2pk",
			addr:    "consensus:q835ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35e2s5j8xs98r",
			encoded: "consensus:q835ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35e2s5j8xs98r",
			valid:   true,
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c, 0xaa}
				return util.NewAddressPublicKeyECDSA(publicKey, util.Bech32PrefixConsensus)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixConsensus,
		},
		...
		},
		{
			...
			addr:           "consensus:qr35ennsep3hxfe7lnz5ee7j5jgmkjswss74as46gx",
			valid:          false,
			passedPrefix:   util.Bech32PrefixConsensus,
			expectedPrefix: util.Bech32PrefixConsensus,
		},
		...
		{
			name:    "mainnet p2sh",
			addr:    "consensus:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdz3qw5ugf7",
			encoded: "consensus:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdz3qw5ugf7",
			valid:   true,
			...
			f: func() (util.Address, error) {
				script := []byte{
					...
					0xae}
				return util.NewAddressScriptHash(script, util.Bech32PrefixConsensus)
			},
			passedPrefix:   util.Bech32PrefixConsensus,
			expectedPrefix: util.Bech32PrefixConsensus,
		},
		{
			name:    "mainnet p2sh 2",
			addr:    "consensus:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxwq98nmep",
			encoded: "consensus:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxwq98nmep",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixConsensus,
				[blake2b.Size256]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixConsensus)
			},
			passedPrefix:   util.Bech32PrefixConsensus,
			expectedPrefix: util.Bech32PrefixConsensus,
		},
		{
			name:    "testnet p2sh",
			addr:    "consensustest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vxfltt45j7",
			encoded: "consensustest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vxfltt45j7",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixConsensusTest,
				[blake2b.Size256]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixConsensusTest)
			},
			passedPrefix:   util.Bech32PrefixConsensusTest,
			expectedPrefix: util.Bech32PrefixConsensusTest,
		},
...
func TestDecodeAddressErrorConditions(t *testing.T) {
	tests := []struct {
		...
		{
			"consensussim:raskzctpv9skzctpv9skzctpv9skzctpvy37ct7zafpv9skzctpvyqfusatdg",
			util.Bech32PrefixConsensusSim,
			"unknown address type",
		},
		{
			"consensussim:raskzcg62uftfgk",
			util.Bech32PrefixConsensusSim,
			"unknown address type",
		},
		{
			"consensustest:qqq65mvpxcmajeq44n2n8vfn6u9f8l4zsyllsa7fye",
			util.Bech32PrefixConsensus,
...
func TestParsePrefix(t *testing.T) {
	tests := []struct {
		...
		{"consensus", util.Bech32PrefixConsensus, false},
		{"consensustest", util.Bech32PrefixConsensusTest, false},
		{"consensussim", util.Bech32PrefixConsensusSim, false},
...
func TestPrefixToString(t *testing.T) {
	tests := []struct {
		...
		{util.Bech32PrefixConsensus, "consensus"},
		{util.Bech32PrefixConsensusTest, "consensustest"},
		{util.Bech32PrefixConsensusSim, "consensussim"},
		{util.Bech32PrefixUnknown, ""},
	}

...
// MsgRequestAddresses implements the Message interface and represents a consensus
...
// NewMsgRequestAddresses returns a new consensus RequestAddresses message that conforms to the

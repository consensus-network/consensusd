...
// MsgTransactionNotFound defines a consensus TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new consensus transactionsnotfound message that conforms to the

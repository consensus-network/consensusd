...
// consensus Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a consensus
// Addresses message.
...
// NewMsgAddresses returns a new consensus Addresses message that conforms to the

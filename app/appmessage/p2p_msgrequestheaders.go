...
// MsgRequestHeaders implements the Message interface and represents a consensus
...
// NewMsgRequstHeaders returns a new consensus RequestHeaders message that conforms to the

...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a consensus
...
// NewMsgDoneBlocksWithTrustedData returns a new consensus DoneBlocksWithTrustedData message that conforms to the
// Message interface.

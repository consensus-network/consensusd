...
var DefaultUserAgent = fmt.Sprintf("/consensusd:%s/", version.Version())

// MsgVersion implements the Message interface and represents a consensus version
...
// NewMsgVersion returns a new consensus version message that conforms to the

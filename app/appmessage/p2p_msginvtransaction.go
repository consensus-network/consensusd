...
// MsgInvTransaction implements the Message interface and represents a consensus
...
// NewMsgInvTransaction returns a new consensus TxInv message that conforms to

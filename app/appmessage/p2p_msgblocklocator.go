...
// MsgBlockLocator implements the Message interface and represents a consensus
...
// NewMsgBlockLocator returns a new consensus locator message that conforms to

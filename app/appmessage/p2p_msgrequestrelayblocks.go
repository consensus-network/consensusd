...
// MsgRequestRelayBlocks implements the Message interface and represents a consensus
...
// NewMsgRequestRelayBlocks returns a new consensus RequestRelayBlocks message that conforms to

...
// MsgRequestAnticone implements the Message interface and represents a consensus
...
// NewMsgRequestAnticone returns a new consensus RequestPastDiff message that conforms to the

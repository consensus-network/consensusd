...
// MsgRequestTransactions implements the Message interface and represents a consensus
...
// NewMsgRequestTransactions returns a new consensus RequestTransactions message that conforms to

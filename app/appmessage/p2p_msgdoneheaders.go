...
// MsgDoneHeaders implements the Message interface and represents a consensus
...
// NewMsgDoneHeaders returns a new consensus DoneIBDBlocks message that conforms to the
// Message interface.

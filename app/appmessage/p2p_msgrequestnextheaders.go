...
// MsgRequestNextHeaders implements the Message interface and represents a consensus
...
// NewMsgRequestNextHeaders returns a new consensus RequestNextHeaders message that conforms to the
// Message interface.

...
// MsgIBDChainBlockLocator implements the Message interface and represents a consensus
...
// NewMsgIBDChainBlockLocator returns a new consensus locator message that conforms to

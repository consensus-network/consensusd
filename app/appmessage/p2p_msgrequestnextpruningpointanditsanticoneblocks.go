...
// MsgRequestNextPruningPointAndItsAnticoneBlocks implements the Message interface and represents a consensus
...
// NewMsgRequestNextPruningPointAndItsAnticoneBlocks returns a new consensus RequestNextPruningPointAndItsAnticoneBlocks message that conforms to the
// Message interface.

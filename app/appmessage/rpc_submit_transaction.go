...
// RPCTransaction is a consensusd transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a consensusd transaction input representation
...
// RPCScriptPublicKey is a consensusd ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a consensusd transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a consensusd outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a consensusd utxo entry representation meant to be used
// over RPC

...
import (
	...
	"github.com/consensus-network/consensusd/app/protocol"
	"github.com/consensus-network/consensusd/app/rpc"
	"github.com/consensus-network/consensusd/domain"
	"github.com/consensus-network/consensusd/domain/consensus"
	"github.com/consensus-network/consensusd/domain/utxoindex"
	...
	"github.com/consensus-network/consensusd/infrastructure/network/connmanager"
	"github.com/consensus-network/consensusd/infrastructure/network/netadapter"
	"github.com/consensus-network/consensusd/infrastructure/network/netadapter/id"
	"github.com/consensus-network/consensusd/util/panics"
)

// ComponentManager is a wrapper for all the consensusd services
...
// Start launches all the consensusd services.
...
// Stop gracefully shuts down all the consensusd services.
func (a *ComponentManager) Stop() {
	// Make sure this only happens once.
	if atomic.AddInt32(&a.shutdown, 1) != 1 {
		log.Infof("Consensusd is already in the process of shutting down")
		return
	}

	log.Warnf("Consensusd shutting down")

...
import (
	...
	"github.com/consensus-network/consensusd/version"
	"github.com/pkg/errors"
)

const (
	defaultConfigFilename      = "consensusd.conf"
	defaultLogLevel            = "info"
	defaultLogDirname          = "logs"
	defaultLogFilename         = "consensusd.log"
	defaultErrLogFilename      = "consensusd_err.log"
	...
	sampleConfigFilename    = "sample-consensusd.conf"
	defaultMaxUTXOCacheSize = 5_000_000_000
	defaultProtocolVersion  = 5
)

var (
	// DefaultAppDir is the default home directory for consensusd.
	DefaultAppDir = util.AppDir("consensusd", false)
...
//go:embed sample-consensusd.conf
...
// Flags defines the configuration options for consensusd.
//
...
type Flags struct {
	...
	MinRelayTxFee                   float64       `long:"minrelaytxfee" description:"The minimum transaction fee in CSS/kB to be considered a non-zero fee."`
...
// Config defines the configuration options for consensusd.
//
// See loadConfig for details on the configuration load process.
type Config struct {
	*Flags
...
// DefaultConfig returns the default consensusd configuration
...
//
// The above results in consensusd functioning properly without any config settings
...
// createDefaultConfig copies the file sample-consensusd.conf to the given destination path,

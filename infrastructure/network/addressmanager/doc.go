/*
Package addressmanager implements concurrency safe Consensus address manager.

# Address Manager Overview

In order maintain the peer-to-peer Consensus network, there needs to be a source
of addresses to connect to as nodes come and go. The Consensus protocol provides

...
func (x *ConsensusdMessage_RequestPruningPointUTXOSet) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "ConsensusdMessage_RequestPruningPointUTXOSet is nil")
	}
...
func (x *ConsensusdMessage_RequestPruningPointUTXOSet) fromAppMessage(

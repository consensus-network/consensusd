...
func (x *p2PMessageStreamClient) Send(m *ConsensusdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*ConsensusdMessage, error) {
	m := new(ConsensusdMessage)
...
func (x *p2PMessageStreamServer) Send(m *ConsensusdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*ConsensusdMessage, error) {
	m := new(ConsensusdMessage)
...
func (x *rPCMessageStreamClient) Send(m *ConsensusdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*ConsensusdMessage, error) {
	m := new(ConsensusdMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *ConsensusdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*ConsensusdMessage, error) {
	m := new(ConsensusdMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}

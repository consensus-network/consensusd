...
func (x *ConsensusdMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "ConsensusdMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *ConsensusdMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {

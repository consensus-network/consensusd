...
import (
	...
	"github.com/consensus-network/consensusd/util/mstime"
	"github.com/pkg/errors"
)

func (x *ConsensusdMessage_Version) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "ConsensusdMessage_Version is nil")
	}
...
func (x *VersionMessage) toAppMessage() (appmessage.Message, error) {
	...
	//  Full consensus nodes set SubnetworkId==nil
	if err != nil && !errors.Is(err, errorNil) {
		return nil, err
	}
...
func (x *ConsensusdMessage_Version) fromAppMessage(msgVersion *appmessage.MsgVersion) error {

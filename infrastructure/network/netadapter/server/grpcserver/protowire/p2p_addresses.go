...
func (x *ConsensusdMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "ConsensusdMessage_Addresses is nil")
	}
...
func (x *ConsensusdMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {

...
//
// Clients are expected to build RequestMessages and wrap them in ConsensusdMessage. (see messages.proto)
//
// Having received a RequestMessage, (wrapped in a ConsensusdMessage) the RPC server will respond with a
// ResponseMessage (likewise wrapped in a ConsensusdMessage) respective to the original RequestMessage.
//
...
// GetPeerAddressesRequestMessage requests the list of known consensusd addresses in the
...
// currently connected to this consensusd.
...
// AddPeerRequestMessage adds a peer to consensusd's outgoing connection list.
// This will, in most cases, result in consensusd connecting to said peer.
...
// parent chain from some startHash to this consensusd's current virtual
...
// GetBlockCountRequestMessage requests the current number of blocks in this consensusd.

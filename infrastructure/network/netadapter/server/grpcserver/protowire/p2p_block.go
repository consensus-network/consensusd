...
func (x *ConsensusdMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "ConsensusdMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *ConsensusdMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {

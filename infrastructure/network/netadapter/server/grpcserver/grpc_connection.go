...
type grpcStream interface {
	Send(*protowire.ConsensusdMessage) error
	Recv() (*protowire.ConsensusdMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.ConsensusdMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.ConsensusdMessage) error {

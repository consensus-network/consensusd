...
// installService attempts to install the consensusd service. Typically this should
...
// removeService attempts to uninstall the consensusd service. Typically this should
...
// startService attempts to Start the consensusd service.
